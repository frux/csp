...
export type CSPBooleanDirectiveName =
	DirectivesOfType<CSPBooleanDirectiveValue>;
export type CSPDirectiveValue =
	| CSPListDirectiveValue
	| CSPStringDirectiveValue
	| CSPBooleanDirectiveValue;
export type CSPListDirectiveValue = (string | false)[];
...
export type CSPDirectives = {
	...
	"script-src": (
		| TFetchDirective
		| typeof STRICT_DYNAMIC
		| typeof REPORT_SAMPLE
		| typeof WASM_UNSAFE_EVAL
	)[];
